                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <Label htmlFor="category">Category (Color Theme)</Label>
                                    <select
                                        id="category"
                                    ...
                                    >
                                        ...
                                        <option value="elective">Elective Module (Container)</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                <Label htmlFor="parentModuleId">Parent Module (Assign to Elective)</Label>
                                <select
                                    id="parentModuleId"
                                ...
                                <div key={course.id} className="flex flex-col bg-surface/50 border border-border rounded-lg p-4 group">
                                    ...
                                    <div className="flex justify-between text-xs text-foreground-muted mt-2 items-center">
                                        ...
                                        <div className="flex flex-col text-right">
                                            <span>Semester {course.semester} ({getSeasonForSemester(course.semester)})</span>
                                            ...
                                            <div className="text-[10px] text-foreground-muted mt-0.5 space-x-2">
                                                {course.examType === 'written' && <span>Written Exam</span>}
                                                {course.examType === 'oral' && <span>Oral Exam</span>}
                                                {course.workloadMin && course.workloadMax && <span>Workload: {course.workloadMin}-{course.workloadMax}h/wk</span>}
                                            </div>
